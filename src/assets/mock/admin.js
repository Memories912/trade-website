...
export const mockInquiries = [
  ...
  { id: 'INQ-005', unreadMessages: 3, productId: 'humidifier', productName: 'Ultrasonic Humidifier 5L', customer: { name: 'Park Ji-yeon', email: 'park@mno.co.kr', company: 'MNO Electronics', country: 'Korea' }, message: 'Interested in 800 units of the humidifier. Please share detailed specs, KC cert, and packaging details.', status: 'pending', notes: [], replies: [], createdAt: '2026-03-13', updatedAt: '2026-03-13' },
  ...
  { id: 'INQ-013', unreadMessages: 1, productId: 'oscillating-tool', productName: 'Oscillating Multi-Tool 300W', customer: { name: 'Roberto Rossi', email: 'roberto@wxy.it', company: 'WXY Srl', country: 'Italy' }, message: 'Please quote 350 units oscillating multi-tool for EU market.', status: 'pending', notes: [], replies: [], createdAt: '2026-03-20', updatedAt: '2026-03-20' },
...
export const mockSourcingRequests = [
  ...
  { id: 'SR-010', unreadMessages: 1, title: 'Battery-Powered Chain Saw 18V', description: 'Need 18V cordless chain saw with 12" bar length, tool-less chain tensioning, and safety brake. For consumer market in Canada.', customer: { name: 'James Wilson', email: 'james@zab.ca', company: 'ZAB Industries', country: 'Canada' }, status: 'pending', quote: null, createdAt: '2026-03-20', updatedAt: '2026-03-20' },
